...
annualRollingExceedanceAnalysis <- function(dataToAnalyze,
  ...
  # Now, stop loop from repeating windows by capping the top end by yearsToRoll-1 (so don't have 3 yr windows exceeding 
  #  assessment period), then remove any windowRange options that don't actually have data in those years
